...
class TestLogin:
    ...
    def test_login_valid_credentials(self, creating_new_user):
        self.login.send_login_request(creating_new_user['user_email'], creating_new_user['password'])
    ...
    def test_login_invalid_password(self, creating_new_user):
        ...
        self.login.send_login_request(creating_new_user['user_email'], wrong_password)
        self.login.should_be_status_code_200()
    ...
    def test_login_invalid_email(self, creating_new_user):
        ...
        self.login.send_login_request(wrong_user_email, creating_new_user['password'])
        self.login.should_be_status_code_200()
        self.login.should_be_text_result_false()
    ...
    def test_login_invalid_credentials(self, creating_new_user):
        ...
        self.login.send_login_request(wrong_user_email, wrong_passwrd)
        self.login.should_be_status_code_200()
        self.login.should_be_text_result_false()
