import unittest
import requests
from nose.tools import assert_equals, assert_is_not_none, assert_equal, assert_in, assert_is_none
...
class BasicTestCase(TestCase):
    ...
    def test_create_double_email(self):
        ...
        assert_equals(double_registration_request[1].json()['message'], ' email ' + email + ' уже есть в базе', 'Error message is wrong')
    ...
    def test_create_double_name(self):
        ...
        assert_equals(double_registration_name[1].json()['message'], ' Текущее ФИО ' + name + ' уже есть в базе', 'Error message is wrong')
